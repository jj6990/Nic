...
<!--               -->
 ...
 <!--                         <link rel="stylesheet" type="text/css" href="templates/CSS/Common/contact-support.css">
                            ...
                            <link rel="stylesheet" type="text/css" href="templates/CSS/Common/Homepage.css">
...
<script type="text/javascript" src="templates/JS/vendor/what-input.js"></script>
                                <script>
                                    ...
                                    if ( !$.isFunction($.cookie) ) {
                                        document.write('<script src="https://cdnassets.com/ui/supersite/en/js/jquery.cookie-1.3.1.js?t=1527660279"><\/script>');
                                    }

                                </script>
                                <script type="text/javascript" src="templates/JS/commonScripts.js"></script>
                                ...
                                <![endif]-->
<script type="text/javascript" src="templates/JS/jquery.innerfade.js"></script>
<script type="text/javascript" src="templates/JS/jquery.scrollTo.js"></script>
