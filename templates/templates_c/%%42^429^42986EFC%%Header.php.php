<?php /* Smarty version 2.6.30, created on 2018-05-31 16:14:14
         compiled from Common/Header/Header.php */ ?>
...
<div  class="new-header-style">
    ...
    <h1 id="branding">
        <span class="logo-cont">
            <span></span>
            <a href="../../index.php"><img src="https://cdnassets.com/getImage.php?url=bea2728277.supersite2.myorderbox.com&src=logo.gif&t=1527660280" alt=""></a>
        </span>
    </h1>
    <!-- ### Template common/header/includes/header_dashboard.html starts here ###  -->
    <?php echo '<?php'; ?>
 include 'Common/Header/Includes/Header_dashboard.html'; <?php echo '?>'; ?>
